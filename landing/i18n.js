const translations = {
  vi: {
    ...
    "features.f1.desc": "Nvidia Riva streaming gRPC với độ trễ dưới một giây. Chữ hiện ngay khi được nói.",
    "features.f2.title": "Nhận diện người nói",
    "features.f2.desc": "ONNX Runtime + CAM++ diarization nhận diện ai đang nói. Mỗi giọng nói được tự động gán nhãn.",
    ...
    "how.s2.desc": "Nhập Nvidia Riva key trong Cài đặt. Gói miễn phí có tại build.nvidia.com.",
    ...
    "m2.desc": "Double-click file <code>.dmg</code>. macOS có thể hiện cảnh báo <strong>\"Scribble_1.1.0_aarch64.dmg Not Opened\"</strong> vì file chưa được ký. Nhấn <strong>\"Done\"</strong> — chúng ta sẽ sửa ở bước tiếp.",
    ...
    "w4.desc": "Vào thư mục <strong>Downloads</strong> và double-click <code>Scribble_1.1.0_x64-setup.exe</code> để bắt đầu cài đặt.",
    ...
    "faq.q3": "Có cần trả phí cho NVIDIA API không?",
    "faq.a3": "Không. NVIDIA cung cấp gói miễn phí tại <a href=\"https://build.nvidia.com\" target=\"_blank\" rel=\"noopener\">build.nvidia.com</a> với đủ credit cho sử dụng cá nhân. Đăng ký và tạo API key miễn phí.",
  ...
  en: {
    ...
    "features.f1.desc": "Nvidia Riva streaming gRPC with sub-second latency. Words appear the moment they're spoken.",
    "features.f2.title": "Speaker Identification",
    "features.f2.desc": "ONNX Runtime + CAM++ diarization identifies who's speaking. Each voice auto-labeled in real-time.",
    ...
    "how.s2.desc": "Enter your Nvidia Riva key in Settings. Free tier available at build.nvidia.com.",
    ...
    "m2.desc": "Double-click the <code>.dmg</code> file. macOS may show a <strong>\"Scribble_1.1.0_aarch64.dmg Not Opened\"</strong> warning because it's unsigned. Click <strong>\"Done\"</strong> for now — we'll fix this in the next step.",
    ...
    "w4.desc": "Go to your <strong>Downloads</strong> folder and double-click <code>Scribble_1.1.0_x64-setup.exe</code> to start the installation.",
    ...
    "faq.q3": "Do I need to pay for the NVIDIA API?",
    "faq.a3": "No. NVIDIA offers a free tier at <a href=\"https://build.nvidia.com\" target=\"_blank\" rel=\"noopener\">build.nvidia.com</a> that provides enough credits for personal use. Sign up and generate an API key for free.",
