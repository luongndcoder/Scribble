const translations = {
  vi: {
    ...
    "m2.desc": "Double-click file <code>.dmg</code>. macOS có thể hiện cảnh báo <strong>\"Scribble_1.0.0_aarch64.dmg Not Opened\"</strong> vì file chưa được ký. Nhấn <strong>\"Done\"</strong> — chúng ta sẽ sửa ở bước tiếp.",
    ...
    "w4.desc": "Vào thư mục <strong>Downloads</strong> và double-click <code>Scribble_1.0.0_x64-setup.exe</code> để bắt đầu cài đặt.",
  ...
  en: {
    ...
    "m2.desc": "Double-click the <code>.dmg</code> file. macOS may show a <strong>\"Scribble_1.0.0_aarch64.dmg Not Opened\"</strong> warning because it's unsigned. Click <strong>\"Done\"</strong> for now — we'll fix this in the next step.",
    ...
    "w4.desc": "Go to your <strong>Downloads</strong> folder and double-click <code>Scribble_1.0.0_x64-setup.exe</code> to start the installation.",
