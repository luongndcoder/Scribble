...
TRANSLATIONS = {
    "vi": {
        ...
        "local_stt_ready": "Chạy offline trên máy — sẵn sàng, không cần mã truy cập",
        "local_model_needs_download": "Cần tải model offline trước (xem mục Local ở trên)",
    ...
    "en": {
        ...
        "local_stt_ready": "Runs offline on-device — ready, no access key needed",
        "local_model_needs_download": "Download the offline model first (see Local section above)",
