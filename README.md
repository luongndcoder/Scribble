...
|---------------|-------------------|---------------|------|
| 🍎 **macOS** | Apple Silicon (M1/M2/M3/M4) | `Scribble_1.1.3_aarch64.dmg` | [⬇ Download](https://github.com/luongndcoder/Scribble/releases/latest/download/Scribble_1.1.3_aarch64.dmg) |
| 🪟 **Windows** | 64-bit | `Scribble_1.1.3_x64-setup.exe` | [⬇ Download](https://github.com/luongndcoder/Scribble/releases/latest/download/Scribble_1.1.3_x64-setup.exe) |
| 🐧 **Linux** | 64-bit (AppImage) | `Scribble_1.1.3_amd64.AppImage` | [⬇ Download](https://github.com/luongndcoder/Scribble/releases/latest/download/Scribble_1.1.3_amd64.AppImage) |
| 🐧 **Linux** | 64-bit (deb) | `scribble_1.1.3_amd64.deb` | [⬇ Download](https://github.com/luongndcoder/Scribble/releases/latest/download/scribble_1.1.3_amd64.deb) |
